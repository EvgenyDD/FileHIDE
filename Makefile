#############################################################################
# Makefile for building: Virus
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  Virus.pro
# Template: app
# Command: C:/Qt/Static/5.3.2/bin/qmake.exe -spec win32-g++ CONFIG+=release -o Makefile Virus.pro
#############################################################################
...
Makefile: Virus.pro C:/Qt/Static/5.3.2/mkspecs/win32-g++/qmake.conf C:/Qt/Static/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=release -o Makefile Virus.pro
